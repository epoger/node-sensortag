...
// TODO_EPOGER: for now, returns the same data for every sample in the callback
  ...
  this.readDataCharacteristic(MPU9250_UUID, MPU9250_DATA_UUID, function(error, data) {
    ...
    this.convertMPU9250Data(data, function(x, y, z) {
      ...
      for (var i=0; i<numSamples; i++) {
        allSamples.push(oneSample);  // TODO_EPOGER: should be pushing different data for each sample
      }
